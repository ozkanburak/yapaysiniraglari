...
plt.scatter(giris[:50, 0], giris[:50, 1], color='green', marker='o', label='setosa')
plt.scatter(giris[50:100, 0], giris[50:100, -1], color='red', marker='x', label='versicolor')
...
siniflandirici = Perceptron(ogrenme_orani=0.1, iter_sayisi=20)
